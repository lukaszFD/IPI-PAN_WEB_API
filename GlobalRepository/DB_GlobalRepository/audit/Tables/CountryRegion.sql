...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Old value - Country id in the database. In relation to [GlobalRepository]. [repository]. [Servers]. [CountryId].', @level0type = N'SCHEMA', @level0name = N'audit', @level1type = N'TABLE', @level1name = N'CountryRegion', @level2type = N'COLUMN', @level2name = N'OLD_CountryId';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'New value - Country id in the database. In relation to [GlobalRepository]. [repository]. [Servers]. [CountryId].', @level0type = N'SCHEMA', @level0name = N'audit', @level1type = N'TABLE', @level1name = N'CountryRegion', @level2type = N'COLUMN', @level2name = N'NEW_CountryId';
