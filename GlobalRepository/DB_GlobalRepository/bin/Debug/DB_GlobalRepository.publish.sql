...
GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [FK__Accounts__RecAcc__220B0B18];


GO
PRINT N'Dropping unnamed constraint on [repository].[Servers]...';


GO
ALTER TABLE [repository].[Servers] DROP CONSTRAINT [FK__Servers__RecServ__26CFC035];


GO
PRINT N'Dropping unnamed constraint on [repository].[Systems]...';


GO
ALTER TABLE [repository].[Systems] DROP CONSTRAINT [FK__Systems__RecSyst__27C3E46E];
