...
GO
/*
The type for column Password in table [gr_user].[Users] is currently  NVARCHAR (200) NULL but is being changed to  VARBINARY (100) NULL. Data loss could occur and deployment may fail if the column contains data that is incompatible with type  VARBINARY (100) NULL.
*/
