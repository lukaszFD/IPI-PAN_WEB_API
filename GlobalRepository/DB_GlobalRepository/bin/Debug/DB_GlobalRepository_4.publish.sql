...
GO
PRINT N'Dropping [repository].[FK__Accounts__Countr__07220AB2]...';


GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [FK__Accounts__Countr__07220AB2];


GO
PRINT N'Dropping [repository].[FK__Accounts__Server__08162EEB]...';


GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [FK__Accounts__Server__08162EEB];


GO
PRINT N'Dropping [repository].[FK__Accounts__System__090A5324]...';


GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [FK__Accounts__System__090A5324];


GO
PRINT N'Dropping [repository].[FK__Accounts__UserId__5EDF0F2E]...';


GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [FK__Accounts__UserId__5EDF0F2E];


GO
PRINT N'Dropping [repository].[FK__Servers__Country__0AF29B96]...';


GO
ALTER TABLE [repository].[Servers] DROP CONSTRAINT [FK__Servers__Country__0AF29B96];


GO
PRINT N'Dropping [gr_user].[UQ_User]...';


GO
ALTER TABLE [gr_user].[Users] DROP CONSTRAINT [UQ_User];


GO
PRINT N'Dropping [gr_user].[CK__Users__Type__5FD33367]...';


GO
ALTER TABLE [gr_user].[Users] DROP CONSTRAINT [CK__Users__Type__5FD33367];


GO
PRINT N'Dropping [repository].[CK__Accounts__Tofix__119F9925]...';


GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [CK__Accounts__Tofix__119F9925];


GO
PRINT N'Dropping [repository].[CK__Accounts__Type__10AB74EC]...';


GO
ALTER TABLE [repository].[Accounts] DROP CONSTRAINT [CK__Accounts__Type__10AB74EC];


GO
PRINT N'Dropping [repository].[CK__Servers__Antivir__1293BD5E]...';


GO
ALTER TABLE [repository].[Servers] DROP CONSTRAINT [CK__Servers__Antivir__1293BD5E];


GO
PRINT N'Dropping [repository].[CK__Servers__HardDis__1387E197]...';


GO
ALTER TABLE [repository].[Servers] DROP CONSTRAINT [CK__Servers__HardDis__1387E197];


GO
PRINT N'Dropping [repository].[CK__Servers__UPS__147C05D0]...';


GO
ALTER TABLE [repository].[Servers] DROP CONSTRAINT [CK__Servers__UPS__147C05D0];
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'repository.Accounts'), OBJECT_ID(N'repository.Servers'), OBJECT_ID(N'gr_user.Users'))
               AND [type] IN (N'F', N'C')
