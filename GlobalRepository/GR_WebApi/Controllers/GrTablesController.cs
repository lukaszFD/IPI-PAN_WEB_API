...
namespace GR_WebApi.Controllers
{
    ...
    public class GrTablesController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<GrTables>>> GetGlobalRespositoryDocumentation([FromQuery] int pageNumber, [FromQuery] int pageSize)
        {
        ...
        public async Task<ActionResult<List<GrTables>>> GetSpecyfikInformationDocumentation(string schema_name, string table_name, [FromQuery] int pageNumber, [FromQuery] int pageSize)
        {
